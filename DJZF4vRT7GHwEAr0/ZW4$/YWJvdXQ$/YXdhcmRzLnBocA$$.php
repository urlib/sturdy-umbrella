...
<title>China Mobile Limited - About China Mobile &gt; Recognition & Awards</title>
...
<style>
	.awardsWrapper .logo img:first-child {padding-top:0px;}
</style>
   ...
   <div class="headerWrapper">
     ...
     <div id="tools-popup" class="mfp-hide">
		 ...
		 <ul class="tools">
                 ...
                 <li><a href="../webform/emailpage.php?page=https://www.chinamobileltd.com/en/about/awards.php" id="emailpage" ><div class="icon"><img src="../images/global/icon_email.png" alt=""/></div>Email this Page</a></li>
    ...
    <div class="row">
    	 <div class="yearBar">
             ...
             <a class="yearNext" href="javascript:void(0);"></a>
                 <div class="yearNav"> 
                    <div class="act"><a href="?year=2020&scroll2title=1" id="year2019" class="act">2020</a></div>      
   ...
   <div class="contentWrapper">
      <div class="row">
         <!-- Content Area Start-->
				  ...
				  <div class="logo"></div>
				  <p>China Mobile Limited was awarded the accolades of "Sustainability and Social Responsibility Reporting Awards" in the H-share Companies and Other Mainland Enterprises Category in the HKICPA’s 20th annual "Best Corporate Governance Awards".</p>
			 </div>
			 <div class="awardsWrapper">
				  <div class="logo"><img src="../../en/images/media/news/news200110.png"></div>
				  <p>China Mobile Limited had won the Gold award in "The Asset ESG Award 2019" held by financial magazine The Asset.</p>
			 </div>
...
<img src="../images/global/breadcrumb_arrow.png" class="arrow"> Recognition & Awards
        </div>
        ...
        <div class="item tools">
            ...
            <ul class="sitemap">
                 ...
                 <li><a href="../webform/emailpage.php?page=https://www.chinamobileltd.com/en/about/awards.php" id="emailpage" >Email this Page</a></li>               
