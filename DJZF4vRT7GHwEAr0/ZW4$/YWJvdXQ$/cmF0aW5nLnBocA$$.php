...
<title>China Mobile Limited - About China Mobile &gt; Credit Ratings</title>
...
<div class="wrapper">
   <div class="headerWrapper">
     ...
     <div id="tools-popup" class="mfp-hide">
		 ...
		 <ul class="tools">
                 ...
                 <li><a href="../webform/emailpage.php?page=https://www.chinamobileltd.com/en/about/rating.php" id="emailpage" ><div class="icon"><img src="../images/global/icon_email.png" alt=""/></div>Email this Page</a></li>
   ...
   <div class="fullWidth">
   	<div class="row">
    	<div class="titleWrapper">
            <div class="title">Credit Ratings</div>
         </div>
    </div>
   </div>
   <div class="contentWrapper">
      <div class="row">
		...
		<p>Currently, the Company's corporate credit ratings are equivalent to China's sovereign credit ratings, namely, A+/Outlook Stable from Standard & Poor's and A1/Outlook Stable from Moody's. These ratings reflect that the Group's sound financial strength, favourable business potential and solid financial management are highly recognized by the market.</p>
		<p align="center"><img src="../images/about/img_cd.png" alt="Credit Ratings" title="Credit Ratings" class="inlinePhoto"/></p>
      </div>
   </div>
...
<img src="../images/global/breadcrumb_arrow.png" class="arrow"> Credit Ratings
        </div>
        ...
        <div class="item tools">
            ...
            <ul class="sitemap">
                 ...
                 <li><a href="../webform/emailpage.php?page=https://www.chinamobileltd.com/en/about/rating.php" id="emailpage" >Email this Page</a></li>               
