...
<title>China Mobile Limited - Media Centre &gt; Media Contact</title>
   ...
   <div class="headerWrapper">
     ...
     <div id="tools-popup" class="mfp-hide">
		 ...
		 <ul class="tools">
                 ...
                 <li><a href="../webform/emailpage.php?page=https://www.chinamobileltd.com/en/media/contact.php" id="emailpage" ><div class="icon"><img src="../images/global/icon_email.png" alt=""/></div>Email this Page</a></li>
      ...
      <div class="row">
         ...
         <div class="shareinfo">
             <div class="col-100">
                ...
                <div class="col-70">60th Floor, The Center, 99 Queen's Road Central, Hong Kong</div>
             </div>
             <div class="col-100">
                <div class="col-30">Tel:</div>
                <div class="col-70">(852) 3121 8888</div>
             </div>
             <div class="col-100">
                <div class="col-30">Fax:</div>
                <div class="col-70">(852) 2511 9092</div>
             </div>
             <div class="col-100">
                <div class="col-30">Email:</div>
                <div class="col-70"><a href="mailto:ca@chinamobilehk.com">ca@chinamobilehk.com</a></div>
             </div>
         </div>
...
<img src="../images/global/breadcrumb_arrow.png" class="arrow"> Media Contact
        </div>
        ...
        <div class="item tools">
            ...
            <ul class="sitemap">
                 ...
                 <li><a href="../webform/emailpage.php?page=https://www.chinamobileltd.com/en/media/contact.php" id="emailpage" >Email this Page</a></li>               
