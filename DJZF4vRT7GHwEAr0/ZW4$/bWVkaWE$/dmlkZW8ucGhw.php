...
<title>China Mobile Limited - Media Centre &gt; Video Gallery</title>
...
<body>
	 <div id="video10" class="mfp-hide">
		 <video width="100%" height="100%" controls>
			<source src="../../video/opening_video_191203.mp4" type="video/mp4">
		 </video>
	 </div>
	 	 <div id="video8" class="mfp-hide">
		 <video width="100%" height="100%" controls>
			<source src="../../video/ir2017.mp4" type="video/mp4">
		 </video>
	 </div>
	 <div id="video7" class="mfp-hide">
		 <video width="100%" height="100%" controls>
			<source src="../../video/ar2016_eng.mp4" type="video/mp4">
		 </video>
	 </div>
	 <div id="video6" class="mfp-hide">
		 <video width="100%" height="100%" controls>
			<source src="../../video/global_partner_con_2016.mp4" type="video/mp4">
		 </video>
	 </div>
	 <div id="video5" class="mfp-hide">
		 <video width="100%" height="100%" controls>
			<source src="../../video/corporate_video.mp4" type="video/mp4">
		 </video>
	 </div>
	 <div id="video4" class="mfp-hide">
		 <video width="100%" height="100%" controls>
			<source src="../../video/ir2016_eng.mp4" type="video/mp4">
		 </video>
	 </div>
	 <div id="video3" class="mfp-hide">
		 <video width="100%" height="100%" controls>
			<source src="../../video/4g_in_my_own_words.mp4" type="video/mp4">
		 </video>
	 </div>
	 <div id="video2" class="mfp-hide">
		 <video width="100%" height="100%" controls>
			<source src="../../video/4g_lte_eng.mp4" type="video/mp4">
		 </video>
	 </div>
	 <div id="video1" class="mfp-hide">
		 <video width="100%" height="100%" controls>
			<source src="../../video/video_custom_eng.mp4" type="video/mp4">
		 </video>
	 </div>
   ...
   <div class="headerWrapper">
     ...
     <div id="tools-popup" class="mfp-hide">
		 ...
		 <ul class="tools">
                 ...
                 <li><a href="../webform/emailpage.php?page=https://www.chinamobileltd.com/en/media/video.php" id="emailpage" ><div class="icon"><img src="../images/global/icon_email.png" alt=""/></div>Email this Page</a></li>
      ...
      <div class="row">
         <!-- Content Area Start-->
		  <div class="videoWrapper">
			 <div class="video">
				  <div class="photo"><img src="../images/media/video/video10.jpg"  alt=""/></div>
				  <a href="#video10" class="videoPop10"><div class="des">China Mobile Global Partners Conference 2019 Opening Video</div></a>
		     </div>
			 			 <div class="video">
				  <div class="photo"><img src="../images/media/video/video8.jpg"  alt=""/></div>
				  <a href="#video8" class="videoPop8"><div class="des">Company's management attending 2017 Interim Results announcement</div></a>
		     </div>
			 <div class="video">
				  <div class="photo"><img src="../images/media/video/video7.jpg"  alt=""/></div>
				  <a href="#video7" class="videoPop7"><div class="des">Company's management attending 2016 Annual Results Announcement</div></a>
		     </div>
			 <div class="video">
				  <div class="photo"><img src="../images/media/video/video6.jpg"  alt=""/></div>
				  <a href="#video6" class="videoPop6"><div class="des">China Mobile Global Partner Conference 2016 Opening Video</div></a>
		     </div>
			 <div class="video">
				  <div class="photo"><img src="../images/media/video/video5.jpg"  alt=""/></div>
				  <a href="#video5" class="videoPop5"><div class="des">Corporate Video</div></a>
		     </div>
			 <div class="video">
				  <div class="photo"><img src="../images/media/video/video4.jpg"  alt=""/></div>
				  <a href="#video4" class="videoPop4"><div class="des">Company's management attending 2016 interim results announcement</div></a>
		     </div>
		     <div class="video">
				  <div class="photo"><img src="../images/media/video/video3.jpg"  alt=""/></div>
				  <a href="#video3" class="videoPop3"><div class="des">4G, in my own words</div></a>
		     </div>
		     <div class="video">
				  <div class="photo"><img src="../images/media/video/video2.jpg"  alt=""/></div>
				  <a href="#video2" class="videoPop2"><div class="des">4G is here</div></a>
		     </div>
		     <div class="video">
				  <div class="photo"><img src="../images/media/video/video1.jpg"  alt=""/></div>
				  <a href="#video1" class="videoPop1"><div class="des">Mobile Changes Life</div></a>
		     </div>
		  </div>
...
<img src="../images/global/breadcrumb_arrow.png" class="arrow"> Video Gallery
        </div>
        ...
        <div class="item tools">
            ...
            <ul class="sitemap">
                 ...
                 <li><a href="../webform/emailpage.php?page=https://www.chinamobileltd.com/en/media/video.php" id="emailpage" >Email this Page</a></li>               
