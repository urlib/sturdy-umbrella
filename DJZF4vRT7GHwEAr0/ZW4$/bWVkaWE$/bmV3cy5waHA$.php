...
<title>China Mobile Limited - Media Centre &gt; News Highlights</title>
   ...
   <div class="headerWrapper">
     ...
     <div id="tools-popup" class="mfp-hide">
		 ...
		 <ul class="tools">
                 ...
                 <li><a href="../webform/emailpage.php?page=https://www.chinamobileltd.com/en/media/news.php" id="emailpage" ><div class="icon"><img src="../images/global/icon_email.png" alt=""/></div>Email this Page</a></li>
   ...
   <div class="fullWidth">
   	<div class="row">
    	<div class="titleWrapper">
            <div class="title">News Highlights</div>
         </div>
    </div>
         ...
         <div class="bubbleWrapper">
                ...
                <div class="row clearfix">
                    <div class="bubbleContainer">
                        <div class="bubble">
                            <p>China Mobile Limited was awarded the accolades of "Sustainability and Social Responsibility Reporting Awards" in the H-share Companies and Other Mainland Enterprises Category in the HKICPA’s 20th annual "Best Corporate Governance Awards".<br><br>
                            The Hong Kong Institute of Certified Public Accountants’ Best Corporate Governance Awards (“Awards”) are proud to be celebrating their 20th year. The Awards are acknowledged for their breadth, depth, and objectivity. They have established a recognized benchmark for Hong Kong’s corporate governance and sustainability/social responsibility reporting standards in the private and public sectors. </p>
                        </div>
                        <div class="bubbleTail"></div>
                        <div class="bubbleDate">10 Jan 2020</div>
                   </div>
                </div>
				...
				<div class="row clearfix">
                    <div class="bubbleContainer">
                        <div class="bubble">
                            <span class="newsimg"><img src="../images/media/news/news200110.png" alt=""/></span>
                            <p>We are pleased to note that China Mobile Limited had won the Gold award in "The Asset ESG Award 2019" held by The Asset.<br><br>
                            The Asset is an influential regional financial magazine in Asia, it has organized the corporate awards for almost 20 years and recognizes the excellence of the listed companies in Asia through professional benchmarking and analysts interviews.</p>
                        </div>
                        <div class="bubbleTail"></div>
                        <div class="bubbleDate">10 Jan 2020</div>
                   </div>
...
<img src="../images/global/breadcrumb_arrow.png" class="arrow"> News Highlights
        </div>
        ...
        <div class="item tools">
            ...
            <ul class="sitemap">
                 ...
                 <li><a href="../webform/emailpage.php?page=https://www.chinamobileltd.com/en/media/news.php" id="emailpage" >Email this Page</a></li>               
