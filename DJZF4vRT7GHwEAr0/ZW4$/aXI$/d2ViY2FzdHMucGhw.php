...
<title>China Mobile Limited - Investor Relations &gt; Presentations / Webcasts</title>
   ...
   <div class="headerWrapper">
     ...
     <div id="tools-popup" class="mfp-hide">
		 ...
		 <ul class="tools">
                 ...
                 <li><a href="../webform/emailpage.php?page=https://www.chinamobileltd.com/en/ir/webcasts.php" id="emailpage" ><div class="icon"><img src="../images/global/icon_email.png" alt=""/></div>Email this Page</a></li>
   ...
   <div class="fullWidth">
   	<div class="row">
    	<div class="titleWrapper">
            <div class="title">Presentations / Webcasts</div>
         </div>
    </div>
   ...
   <div class="contentWrapper">
      <div class="row">
         <!-- Content Area Start-->
         	...
         	<div class="cover"><img src="../images/ir/presentaion/pre_ar2019.jpg" width="350" height="264" alt=""/></div>
            <div class="content">
            	<div class="date">21 Mar 2019</div>
                <div class="title"><span class="greenText">2019</span> Annual Results Presentation</div>
                <div class="download"><a href="webcasts/pre190321.pdf" target="_blank">Download</a></div>
                <div class="video"><a href="http://mms.prnasia.com/00941/20190321/default.htm" target="_blank">Video</a></div>
            </div>
         </div>-->
         <div class="presentationWrapper">
         	<div class="cover"><img src="../images/ir/presentaion/pre_ir2019.jpg" width="350" height="264" alt=""/></div>
            <div class="content">
            	<div class="date">08 Aug 2019</div>
                <div class="title"><span class="greenText">2019</span> Interim Results Presentation</div>
                <div class="download"><a href="webcasts/pre190808.pdf" target="_blank">Download</a></div>
                <div class="video"><a href="http://mms.prnasia.com/00941/20190808/default.htm" target="_blank">Video</a></div>
            </div>
         </div>
...
<img src="../images/global/breadcrumb_arrow.png" class="arrow"> Presentations / Webcasts
        </div>
        ...
        <div class="item tools">
            ...
            <ul class="sitemap">
                 ...
                 <li><a href="../webform/emailpage.php?page=https://www.chinamobileltd.com/en/ir/webcasts.php" id="emailpage" >Email this Page</a></li>               
