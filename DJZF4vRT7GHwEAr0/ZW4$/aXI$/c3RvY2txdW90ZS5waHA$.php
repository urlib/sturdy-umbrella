...
<title>China Mobile Limited - Investor Relations &gt; Shareholders Service</title>
...
<div class="wrapper">
   <div class="headerWrapper">
     ...
     <div id="tools-popup" class="mfp-hide">
		 ...
		 <ul class="tools">
                 ...
                 <li><a href="../webform/emailpage.php?page=https://www.chinamobileltd.com/en/ir/stockquote.php" id="emailpage" ><div class="icon"><img src="../images/global/icon_email.png" alt=""/></div>Email this Page</a></li>
   ...
   <div class="fullWidth">
   	<div class="row">
    	<div class="titleWrapper">
            <div class="title">Shareholders Service</div>
         </div>
    </div>
    ...
    <div class="row">
         <div class="yearBar">
             ...
             <div class="iconNav">
                <div class="act"><a href="stockquote.php?scroll2title=1" id="btn_stockquote" class="act"><img src="../images/global/icon_stockQuotes.svg" alt="Stock Quotes & Chart"/></a><span class="act">Stock Quotes<br>& Chart</span></div>
                <div class=""><a href="newschart.php?scroll2title=1" id="btn_newschart" class=""><img src="../images/global/icon_newsChart.svg" alt="News Chart"/></a><span class="">News Chart</span></div>
                <div class=""><a href="historical.php?scroll2title=1" id="btn_historical" class=""><img src="../images/global/icon_historical.svg" alt="Historical Prices Lookup"/></a><span class="">Historical Prices<br>Lookup</span></div>
                <div class=""><a href="dividend.php?scroll2title=1" id="btn_dividend" class=""><img src="../images/global/icon_dividend.svg" alt="Dividend History"/></a><span class="">Dividend<br>History</span></div>
                
                
                <!--<div class=""><a href="ircalendar.php?scroll2title=1" id="btn_ircalendar" class=""><img src="../images/global/icon_calendar.svg" alt="IR Calendar"/></a><span class="">IR Calendar</span></div>-->
                <div class=""><a href="shareinfo.php?scroll2title=1" id="btn_shareinfo" class=""><img src="../images/global/icon_shareinfo.svg" alt="ShareInformation"/></a><span class="">Share<br>Information</span></div>
                <div class=""><a href="shareholdingstructure.php?scroll2title=1" id="btn_shareholdingstructure" class=""><img src="../images/global/icon_shareholding.svg" alt="Shareholding Structure"/></a><span class="">Shareholding<br>Structure</span></div>
                <div><a href="http://www.computershare.com/hk-en/lost-certs/Pages/default.aspx?companycode=00941" target="_blank"><img src="../images/global/icon_lost.svg" alt="Replacement ofLost Shares"/></a><span>Replacement<br>of Lost Shares</span></div>
             </div>
         </div>
   </div>
</div>
   <div class="contentWrapper">
   		<style>
		#stockquoteWrapper{height:1700px;}
		@media (min-width: 480px){
			#stockquoteWrapper{height:1200px;}
		}
		@media (min-width: 768px){
			#stockquoteWrapper{height:1000px;}
		}
		</style>
		<div class="row">
			<div id="stockquoteWrapper">
				<IFRAME SRC="https://www.irasia.com/stocks/new2_0941/stockquote_en.php" WIDTH="100%" HEIGHT="100%" FRAMEBORDER="0" MARGINHEIGHT="0" MARGINWIDTH="0" SCROLLING="NO" allowTransparency="true"></IFRAME>                    
			</div>
		</div>
   </div>
...
<img src="../images/global/breadcrumb_arrow.png" class="arrow"> Shareholders Service
        </div>
        ...
        <div class="item tools">
            ...
            <ul class="sitemap">
                 ...
                 <li><a href="../webform/emailpage.php?page=https://www.chinamobileltd.com/en/ir/stockquote.php" id="emailpage" >Email this Page</a></li>               
...
$(function(){
	var index = $("#btn_stockquote").parent("div").index();
	console.log(index);
