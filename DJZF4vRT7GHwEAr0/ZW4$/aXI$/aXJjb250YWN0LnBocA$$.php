...
<title>China Mobile Limited - Investor Relations &gt; IR Contact</title>
   ...
   <div class="headerWrapper">
     ...
     <div id="tools-popup" class="mfp-hide">
		 ...
		 <ul class="tools">
                 ...
                 <li><a href="../webform/emailpage.php?page=https://www.chinamobileltd.com/en/ir/ircontact.php" id="emailpage" ><div class="icon"><img src="../images/global/icon_email.png" alt=""/></div>Email this Page</a></li>
   ...
   <div class="fullWidth">
   	<div class="row">
    	<div class="titleWrapper">
            <div class="title">IR Contact</div>
         </div>
    </div>
   </div>
      ...
      <div class="row">
         ...
         <div class="shareinfo">
             ...
             <div class="col-100">
                ...
                <div class="col-70"><a href="mailto:ir@chinamobilehk.com">ir@chinamobilehk.com</a></div>
             </div>
         </div>
      </div>
   </div>
...
<img src="../images/global/breadcrumb_arrow.png" class="arrow"> IR Contact
        </div>
        ...
        <div class="item tools">
            ...
            <ul class="sitemap">
                 ...
                 <li><a href="../webform/emailpage.php?page=https://www.chinamobileltd.com/en/ir/ircontact.php" id="emailpage" >Email this Page</a></li>               
