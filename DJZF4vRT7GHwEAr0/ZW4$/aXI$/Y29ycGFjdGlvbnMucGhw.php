...
<title>China Mobile Limited - Investor Relations &gt; Corporate Actions</title>
   ...
   <div class="headerWrapper">
     ...
     <div id="tools-popup" class="mfp-hide">
		 ...
		 <ul class="tools">
                 ...
                 <li><a href="../webform/emailpage.php?page=https://www.chinamobileltd.com/en/ir/corpactions.php" id="emailpage" ><div class="icon"><img src="../images/global/icon_email.png" alt=""/></div>Email this Page</a></li>
   ...
   <div class="fullWidth">
   	<div class="row">
    	<div class="titleWrapper">
            <div class="title">Corporate Actions</div>
         </div>
    </div>
   </div>
   <div class="contentWrapper">
      <div class="row">
		...
		<div class="subTitleWrapper q">
		   ...
		   <div class="subTitle">November 2015: The Acquisition of TieTong</div>
		</div>
        <p>In November 2015, the Company, through its wholly-owned subsidiary China Mobile Tietong Company Limited, entered into an acquisition agreement with China TieTong Telecommunications Corporation (“TieTong”) to acquire certain assets and businesses of TieTong at a final consideration of RMB31.967 billion. </p>
        <p>The acquisition enabled us to obtain a wireline broadband license and accelerated the implementation of our full-service strategy that enhanced our competitive strength.  Apart from seizing the opportunity to tap into the wireline broadband market and reap the benefits from the growth in digitally enabled families, we were able to expand our customer base and improve customer retention by bundling wireline and mobile services.  The acquisition boasted significant strategic value for its providing us with immediate scale through complementary network assets, thus creating synergy in increasing our network capabilities, coverage and efficiency with an integrated network. </p>
        <p>For more details about the acquisition, please click <a href="../file/view.php?id=150479" target="_blank">here</a>.</p>

		<div class="subTitleWrapper q">
		   <div class="subTitleBg"><img src="../images/global/subtitleBg.png" alt=""/></div>
		   <div class="subTitle">October 2015: The Transfer of Tower Assets</div>
		</div>
        <p>In October 2015, China Mobile Communication Company Limited (“CMC”), a wholly-owned subsidiary of the Company, transferred its existing telecommunications towers and related assets to China Tower Corporation Limited (“China Tower”) on an arm’s length basis at a final consideration of RMB102.736 billion. Pursuant to the transaction agreement, China Tower has issued 45.151 billion consideration shares to CMC at an issue price of RMB1 per share, and a cash consideration of RMB57.585 billion shall also be payable to CMC.  Of the cash consideration, the first RMB5 billion was paid on 25 February 2016, while the remaining RMB52.585 billion will be paid before 31 December 2017 with an interest rate of 3.92% per annum to be charged.  The transaction generated a one-off gain of RMB10.096 billion. </p>
        <p>Upon the completion of the transaction, CMC has become the single largest shareholder of China Tower with 38.0% equity interests. China Tower’s centralized construction and operation of telecommunications towers resources would enable us to obtain more network infrastructure resources through co-construction and sharing, and to save our capital expenditure.  In addition, as one of the major shareholders of China Tower, we expect to benefit from China Tower’s future earnings and value enhancement. </p>
        <p>For more details about the transaction, please click <a href="../file/view.php?id=148842" target="_blank">here</a>.</p>
...
<img src="../images/global/breadcrumb_arrow.png" class="arrow"> Corporate Actions
        </div>
        ...
        <div class="item tools">
            ...
            <ul class="sitemap">
                 ...
                 <li><a href="../webform/emailpage.php?page=https://www.chinamobileltd.com/en/ir/corpactions.php" id="emailpage" >Email this Page</a></li>               
