...
<title>China Mobile Limited - Investor Relations &gt; Monthly Customer Data</title>
   ...
   <div class="headerWrapper">
     ...
     <div id="tools-popup" class="mfp-hide">
		 ...
		 <ul class="tools">
                 ...
                 <li><a href="../webform/emailpage.php?page=https://www.chinamobileltd.com/en/ir/operation_m.php" id="emailpage" ><div class="icon"><img src="../images/global/icon_email.png" alt=""/></div>Email this Page</a></li>
   ...
   <div class="fullWidth">
   	<div class="row">
    	<div class="titleWrapper">
            <div class="title">Monthly Customer Data</div>
         </div>
    </div>
    <div class="highlightWrapper">
	<div class="row">
        <div id="opChart_m1" class="opChart"></div>
        <div id="opChart_m2" class="opChart"></div>
        <div id="opChart_m3" class="opChart"></div>
    </div>
</div>
    ...
    <div class="row">
    	 <div class="yearBar">
             ...
             <a class="yearNext" href="javascript:void(0);"></a>
                 <div class="yearNav operationNav">  
					<div class="act"><a href="?year=2020&scroll2title=1" id="year2020" class="act">2020</a></div> 
                 	<div class=""><a href="?year=2019&scroll2title=1" id="year2019" class="">2019</a></div>
...
<div class="tableStyle01">
    <div class="tableExcel"><a href="operation/gen_excel_monthly.php?year=2020" target="_blank"></a></div>
</div>



<div class="tableStyle01">
	<div class="title">Mobile Business</div>
	<div class="tableExcel">Customer Base ( in thousands )</div>
	<div class="clear"></div>
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	   <thead>
		  <tr>
			 <th>&nbsp;</th>
			 			  <th width="16%">Total<br>Customers</th>
			 			  <th width="18%">Net Additional<br>Customers<br>for the Month</th>
			 			  <th width="20%">Cumulative Net<br>Additional Customers<br>for the Year</th>
			 			  <th width="14%">4G<br>Customers</th>
			 			  <th width="14%">5G Package<br>Customers</th>
			 		  </tr>
		</thead>
		<tbody>
						<tr>
 ...
 <p>&nbsp;</p>
 <div class="tableStyle01">
	<div class="title">Wireline Broadband Business</div>
	<div class="tableExcel">Customer Base ( in thousands )</div>
	<div class="clear"></div>
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	   <thead>
 ...
 <p>&nbsp;</p>
  <p class="remark">5G package customers are mobile customers (excluding IoT customers) who have subscribed to 5G tariff plans. Customers sharing 5G tariff plans without subscription are not included.</p>          
...
<img src="../images/global/breadcrumb_arrow.png" class="arrow"> Monthly Customer Data
        </div>
        ...
        <div class="item tools">
            ...
            <ul class="sitemap">
                 ...
                 <li><a href="../webform/emailpage.php?page=https://www.chinamobileltd.com/en/ir/operation_m.php" id="emailpage" >Email this Page</a></li>               
