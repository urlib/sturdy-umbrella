...
<title>China Mobile Limited -  &gt; RSS Feeds</title>
   ...
   <div class="headerWrapper">
     ...
     <div id="tools-popup" class="mfp-hide">
		 ...
		 <ul class="tools">
                 ...
                 <li><a href="../webform/emailpage.php?page=https://www.chinamobileltd.com/en/global/rss.php" id="emailpage" ><div class="icon"><img src="../images/global/icon_email.png" alt=""/></div>Email this Page</a></li>
      ...
      <div class="row">
         ...
         <div class="tableStyle01 alignleft">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tbody>
					<tr>
						<th><a href="http://www.irasia.com/cgi-local/news/rss.cgi?id=chinamobile&loc=hk&t=p&title_for_section=yes" target="_blank">Press Releases &nbsp; <img src="../images/global/rss_icon.png"></a></th>
					</tr>
					<tr>
						<th><a href="http://www.irasia.com/cgi-local/news/rss.cgi?id=chinamobile&loc=hk&t=c&title_for_section=yes" target="_blank">Circulars &nbsp; <img src="../images/global/rss_icon.png"></a></th>
					</tr>
					<tr>
						<th><a href="http://www.irasia.com/cgi-local/news/rss.cgi?id=chinamobile&loc=hk&t=r&title_for_section=yes" target="_blank">Financial Reports &nbsp; <img src="../images/global/rss_icon.png"></a></th>
					</tr>
					<tr>
						<th><a href="http://www.irasia.com/cgi-local/news/rss.cgi?id=chinamobile&loc=hk&t=a&title_for_section=yes" target="_blank">Announcements &nbsp; <img src="../images/global/rss_icon.png"></a></th>
					</tr>
				</tbody>
			</table>
            ...
            <div class="subSubTitle">What is RSS</div>
            <p>RSS (Really Simple Syndication or Rich Site Summary) provides a convenient way to gather and quickly browse information from a variety of sources, including press releases, product updates, or changes to a web site. Small amounts of content, called "feeds", are automatically sent to an RSS reader. Feeds are generally a headline, summary, or preview of the complete content. Through the RSS reader, feeds from various sources can be scanned with the ability to access the complete content relating to any interesting feeds.</p>
            
            <div class="subSubTitle">How to subscribe RSS Feeds</div>
			<p>After setting up the RSS reader, you are ready to receive news from China Mobile's RSS feeds. Subscribe to a feed by clicking on one of the feed link buttons on this page and then copying the location (URL) from the address bar of your browser to your clipboard. Follow the instructions for your particular RSS reader, and then paste the location (URL) wherever it asks for the location of the service to which you wish to subscribe.</p>
...
<div class="sitemapWrapper">
      <div class="row">
      	<div class="breadCrumb">
            ...
            <img src="../images/global/breadcrumb_arrow.png" class="arrow"> RSS Feeds
        </div>
        ...
        <div class="item tools">
            ...
            <ul class="sitemap">
                 ...
                 <li><a href="../webform/emailpage.php?page=https://www.chinamobileltd.com/en/global/rss.php" id="emailpage" >Email this Page</a></li>               
